...
export default function Cashier() {
  console.log("🛒 Página do Caixa carregada - timestamp:", new Date().toISOString());
    ...
    <>
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4 max-h-[60vh] overflow-y-auto">
          {sales.length > 0 && (
            <div className="mb-4">
              <h2 className="text-lg font-semibold text-foreground mb-2">Vendas Registradas ({sales.length})</h2>
              <p className="text-sm text-muted-foreground">Todas as vendas feitas no sistema</p>
            </div>
          )}
          {sales.map((sale) => (
